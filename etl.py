...
def process_log_file(cur, filepath):
    ...
    for index, row in df.iterrows():
        ...
        songplay_data = [pd.to_datetime(row.ts, unit='ms'),df.userId.values[c],df.level.values[c],df.song.values[c],df.artist.values[c],int(df.sessionId.values[c]),df.location.values[c],df.userAgent.values[c]]
